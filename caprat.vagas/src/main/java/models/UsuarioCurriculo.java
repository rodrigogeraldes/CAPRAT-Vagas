...
public class UsuarioCurriculo {
	...
	public UsuarioCurriculo(int idCurriculo, int idUsuario, String nomeUsuario, String nascimentoUsuario,
			String enderecoUsuario, String cidadeUsuario, String estadoUsuario, 
			String escolaridadeUsuario, String contatoUsuario, String cursosUsuario,
	...
	public String getCamposString() {
		return "idCurriculo, usuariocurriculo.idUsuario, nomeUsuario, nascimentoUsuario, enderecoUsuario, cidadeUsuario, estadoUsuario,"
				+ " escolaridadeUsuario, contatoUsuario, cursosUsuario, expTrabUsuario, faixaSalarialUsuario";
	}
